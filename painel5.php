...
?>	
    ...
    i = 0;
    tempo = 1;
    tamanho = document.getElementById('painel').scrollTop;
    ...
    <body>
<div id="painel" style="font: 15px Tahoma; cursor: default; height: 600px; width: 1300px; overflow: hidden; padding-left: 10px; padding-right: 10px" onmouseover="Parar()" onmouseout="Rolar()">
...
do {
if ($linha1['status'] == 1){
	echo '<tr class="d0">'; $sala = "<img src='imagens/img/Red pin.png'>Turma encerrada"; } else {	
if ($linha1['titular'] == '99999') {
	echo "<tr>"; $sala = "<img src='imagens/img/Green pin.png'>Turma livre"; } else { echo '<tr>'; $sala = "<img src='imagens/img/Blue pin.png'>Turma em substitui&ccedil;&atilde;o";} }
echo "<td align='center'>".utf8_encode($linha1['id']);
if ($linha1['dificil'] == 1){ echo "<img src='imagens/img/Red tag.png' />"; }
echo "</td>";	
