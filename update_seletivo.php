...
$sql = "update pseletivo set nome = '".$nome."', opcao = '".$opcao."', rg = '".$rg."', cpf = ".$cpf.", titulo = ".$titulo.", sexo = '".$sexo."', reservista = ".$reservista.", casamento = ".$casamento.", nascimento = ".$nascimento.", residencia = ".$residencia.", diploma = ".$diploma.", historico =  ".$historico.", tempo = ".$tempo.", cursos = ".$cursos.", pos = ".$pos.", mestrado = ".$mestrado.", doutorado = ".$doutorado.", ponto_tempo = ".$ponto_tempo.", ponto_curso = ".$ponto_curso.", ponto_pos = ".$ponto_pos.", ponto_mestrado = ".$ponto_mestrado.", ponto_doutorado = ".$ponto_doutorado.", obs = '".$obse."', ativo = ".$ativo." where id = ".$id.";";
      // echo $sql;
