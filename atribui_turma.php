...
break;
case 6 : //atribui segunda atribuição
$sql = "update turmas set 2suplente = ".$docente.", status = 1, hora_atrib = current_timestamp where id = ".$turma.";";
$sql1 = "update classifica_professor set turma = ".$turma.", tipo_atrib = ".$tipo." where id = ".$id_docente.";";break;
case 7 : //cancela segunda atribuição
$sql = "update turmas set 2suplente = 99999, status = 0 where id = ".$turma.";";
$sql1 = "update classifica_professor set turma = 0, tipo_atrib = 0 where id = ".$id_docente.";";
break;
case 8 : //cancela atribuição suplencia
$sql = "update turmas set status = 0 where id = ".$turma.";";
$sql1 = "";
break;
}
$result = mysql_query($sql, $conexao);
$result1 = mysql_query($sql1, $conexao);
if($result) echo "<script>carrega('atribui_docente1.php?id=".$id_docente."&tipo=".$_GET["tipo2"]."&matricula=', $docente, 'conteudo')</script>";
